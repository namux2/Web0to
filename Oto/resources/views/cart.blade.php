  ...
  <div class="container">
    ...
    <table style="width: 100%;">
        <tr>
            <td>Họ và Tên:</td>
            <td>
                <input type="text" name="customer_name" class="form-control form-control-sm" style="width: 100%;" required>
            </td>
        </tr>
        <tr>
            <td>Số Điện Thoại:</td>
            <td>
                <input type="text" name="customer_phone" class="form-control form-control-sm" style="width: 100%;" required>
            </td>
        </tr>
        <tr>
            <td>Email:</td>
            <td>
                <input type="email" name="customer_email" class="form-control form-control-sm" style="width: 100%;" required>
            </td>
        </tr>
        <tr>
            <td>Địa Chỉ:</td>
            <td>
                <input type="text" name="customer_address" class="form-control form-control-sm" style="width: 100%;" required>
            </td>
        </tr>
        <tr>
            <td>Ghi chú:</td>
            <td>
                <textarea name="order_note" class="form-control" rows="4" style="width: 100%;"></textarea>
            </td>
        </tr>
    </table>
    <br>
