...
<body>
  ...
  <div class="container">
    ...
    <div class="form-floating mb-3">
        <input type="text" class="form-control @error('name') is-invalid @enderror" id="floatingName" placeholder="Full Name" name="name" required>
    ...
    <div class="form-floating mb-3">
        <input type="email" class="form-control @error('email') is-invalid @enderror" id="floatingEmail" placeholder="Email" name="email" required>
    ...
    <div class="form-floating mb-3">
        <input type="password" class="form-control @error('password') is-invalid @enderror" id="floatingPassword" placeholder="Mật khẩu" name="password" required>
    ...
    <div class="form-floating mb-3">
        <input type="password" class="form-control" id="floatingConfirmPassword" placeholder="Xác nhận mật khẩu" name="password_confirmation" required>
        <label for="floatingConfirmPassword">Xác nhận mật khẩu</label>
    </div>
    <div class="form-check mb-3">
        <input class="form-check-input @error('terms') is-invalid @enderror" type="checkbox" value="1" id="agreeTermsCheck" name="terms" required>
    ...
    <div class="d-grid">
        <button class="btn btn-primary btn-register text-uppercase fw-bold" type="submit">Đăng ký</button>
    </div>
</form>
