...
<a href="{{ route('logout') }}" style="color: white;">Đăng Xuất</a>
        ...
        <!-- /. NAV SIDE  -->
        <div id="page-wrapper">
        <div id="page-inner" style="min-height: 1588px;">
                    <div class="row">
                    <div class="col-md-12">
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" id="hang_xe" name="hang_xe" required>
    </div>

    <div class="form-group">
        <label for="ten_xe">Tên Xe</label>
        <input class="form-control" type="text" id="ten_xe" name="ten_xe" required>
    </div>

    <div class="form-group">
        <label for="nam_san_xuat">Năm Sản Xuất</label>
        <input class="form-control" type="text" id="nam_san_xuat" name="nam_san_xuat" required>
    </div>

    <div class="form-group">
        <label for="gia_ban">Giá Bán</label>
        <input class="form-control" type="text" id="gia_ban" name="gia_ban" required>
    </div>

    <div class="form-group">
        <label for="noi_ban">Nơi Bán</label>
        <input class="form-control" type="text" id="noi_ban" name="noi_ban" required>
    </div>

    <div class="form-group">
        <label for="so_km">Số KM đã chạy</label>
        <input class="form-control" type="text" id="so_km" name="so_km" required>
    </div>

    <div class="form-group">
        <label for="ngay_ban">Ngày Bán</label>
        <input class="form-control" type="date" id="ngay_ban" name="ngay_ban" required>
    </div>
    ...
    <div class="form-group">
        ...
        <input class="form-control" type="text" id="dong_xe" name="dong_xe" required>
    </div>

    <div class="form-group">
        <label for="nhien_lieu">Nhiên Liệu</label>
        <input class="form-control" type="text" id="nhien_lieu" name="nhien_lieu" required>
    </div>

    <div class="form-group">
        <label for="xuat_xu">Xuất Xứ</label>
        <input class="form-control" type="text" id="xuat_xu" name="xuat_xu" required>
    </div>

    <div class="form-group">
        <label for="kieu_dang">Kiểu Dáng</label>
        <input class="form-control" type="text" id="kieu_dang" name="kieu_dang" required>
    </div>

    <div class="form-group">
        <label for="so_cho">Số Chỗ</label>
        <input class="form-control" type="text" id="so_cho" name="so_cho" required>
    </div>
  
    <div class="form-group">
        <label for="dong_co">Động Cơ</label>
        <input class="form-control" type="text" id="dong_co" name="dong_co" required>
    </div>
