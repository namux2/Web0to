...
<a href="{{ route('logout') }}" style="color: white;">Đăng Xuất</a>
                    ...
                    <li>
                        <a href="#"><i class="fa fa-desktop "></i>Đơn Hàng <span class="fa arrow"></span></a>
                         <ul class="nav nav-second-level">
                             <li>
                                <a class="active-menu" href="donhang"><i class="fa fa-key "></i>List Đơn Hàng</a>
                            </li>
                        </ul>
                    </li>
                    <li>
        ...
        <div id="page-inner">
                <div class="row">
                    <div class="col-md-12">
                        <h1 class="page-head-line">Trang Đơn Hàng</h1>
        ...
        <table class="table table-striped table-bordered table-hover">
            <thead>
                <tr>
                    ...
                    <th>Số điện thoại</th>
                    <th>Ghi chú</th>
                    <th style="padding-left:15%">Đơn Hàng</th>
                    <th >Xóa</th>
                    <th >Sửa</th>


                    <!-- Thêm các cột khác tùy theo đơn hàng -->
                </tr>
            </thead>
            <tbody>
    ...
    <tr>
        ...
        <td>
            <ul>
                @foreach ($order->orderDetails as $orderDetail)
                        ...
                        Sản phẩm: {{ $orderDetail->product->ten_xe }}
        ...
        <td>
        <form action="{{ route('admin.donhang.delete', $order->id) }}" method="POST" onsubmit="return confirm('Bạn có chắc muốn xóa đơn hàng này không?')">
    @csrf
    @method('DELETE')
    <button type="submit" class="btn btn-danger">
     ...
     <td>
     <a href="{{ route('admin.donhang.edit', $order->id) }}">Sửa
</a>
